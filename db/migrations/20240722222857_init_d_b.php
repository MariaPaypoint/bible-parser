...
final class InitDB extends AbstractMigration
{
    public function up()
    {
		...
		");
		$this->execute("CREATE TABLE `bible_translations` (
		...
		");
		$this->execute("CREATE TABLE `bible_books` (
		  `code` int NOT NULL AUTO_INCREMENT,
		...
		");
		$this->execute("CREATE TABLE `bible_verses` (
		  `code` int NOT NULL AUTO_INCREMENT,
		...
		");
		$this->execute("CREATE TABLE `bible_notes` (
		  `code` int NOT NULL AUTO_INCREMENT,
		...
		");
		$this->execute("CREATE TABLE `audio_voices` (
		  `code` int NOT NULL AUTO_INCREMENT,
		  `alias` varchar(50) NOT NULL,
		  `name` varchar(255) NOT NULL,
		...
		");
        $this->execute("CREATE TABLE `audio_alignments` (
		  `code` int NOT NULL AUTO_INCREMENT,
